...
namespace TheWaver
{
    public class Player : DrawableGameComponent
    {
        ...
        /********************************************************************/
        public Player(Game game, ref Texture2D playerShipTexture, ref Texture2D playerLeft, ref Texture2D playerDown, ref Texture2D playerUp, ref Texture2D crosshair, ref GraphicsDeviceManager graphics, ref Texture2D cannon, ref Texture2D plasma,PlayerIndex playerID, Rectangle rectangle)
            : base(game)
        {
        ...
        private void HandlePlayer1KeyBoard()
        {
            ...
            if (keyboard.IsKeyDown(Keys.W))
            {
                ...
                cannonPosition.X = position.X + playerUp.Width / 2 + 4f;
                cannonPosition.Y = position.Y + playerUp.Height / 2;
            }
            if (keyboard.IsKeyDown(Keys.S))
            {
                ...
                position.Y += (1 + speedPower);
                playerRectangle = verticalRectangle;
                cannonPosition.X = position.X + playerDown.Width / 2 + 4f;
                cannonPosition.Y = position.Y + playerDown.Height / 2;
            }
